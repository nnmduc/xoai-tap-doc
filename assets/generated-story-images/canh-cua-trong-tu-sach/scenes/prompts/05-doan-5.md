...
Story: Cánh Cửa Trong Tủ Sách
Section: Đoạn 5
Bối cảnh: Bàn đọc sách.
Nội dung: Cô Thư hỏi: “Hai con thấy gì trong sách?” Minh kể về ngọn đồi.

Detected character references for this section:
- Minh: use the reference image at assets/generated-story-images/canh-cua-trong-tu-sach/characters/01-minh.png as-is.
- Cô Thư: use the reference image at assets/generated-story-images/canh-cua-trong-tu-sach/characters/03-co-thu.png as-is.

All story character references available if the paragraph implies them:
- Minh: assets/generated-story-images/canh-cua-trong-tu-sach/characters/01-minh.png
- Hoa: assets/generated-story-images/canh-cua-trong-tu-sach/characters/02-hoa.png
- Cô Thư: assets/generated-story-images/canh-cua-trong-tu-sach/characters/03-co-thu.png
