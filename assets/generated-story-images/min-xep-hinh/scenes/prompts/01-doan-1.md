...
Story: Min Xếp Hình
Section: Đoạn 1
Bối cảnh: Min ngồi trên thảm cạnh bà, trước nhiều miếng hình.
Nội dung: Min cầm hình vuông. Hình vuông có bốn cạnh.

Detected character references for this section:
- Min: use the reference image at assets/generated-story-images/min-xep-hinh/characters/01-min.png as-is.
- Bà: use the reference image at assets/generated-story-images/min-xep-hinh/characters/02-ba.png as-is.

All story character references available if the paragraph implies them:
- Min: assets/generated-story-images/min-xep-hinh/characters/01-min.png
- Bà: assets/generated-story-images/min-xep-hinh/characters/02-ba.png
